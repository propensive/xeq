...
// Must match the daemon's view of the base directory (`spec/layout.md`; Soundness's
// `ethereal_core.scala` reaches it as `Directories.runtimeDir.or(Directories.stateHome)`),
